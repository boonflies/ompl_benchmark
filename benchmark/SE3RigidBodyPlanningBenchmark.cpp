...
b.addPlanner(std::make_shared<geometric::InformedRRTstar>(setup.getSpaceInformation()));
b.addPlanner(std::make_shared<geometric::GRRTstar>(setup.getSpaceInformation()));
